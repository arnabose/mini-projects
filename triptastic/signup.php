...
<body>
    <div class="logo">
        <img src="image/logo.png" alt="logo" width="44" height="35">TRIPTASTIC
    </div>
    <div class="position">
        <div class="box">
            <h3>USER SIGNUP</h3>
            <form action="" method="post">
                ...
                <div class="mb-3 col-md-12">
                    ...
                    <input type="tel" name="phone" title="it should contain 10 digits not starting with 0" pattern="[1-9]{1}[0-9]{9}"class="form-control" id="exampleInputPassword1" required>
                </div>
                <div class="mb-3 col-md-12">
                    <label class="form-label">Address:<span class="text-danger">*</span></label>
                    <textarea  name="address" rows="3" cols="30" class="form-control" placeholder="Enter your address" required></textarea>
                </div>
                <div class="mb-3 col-md-12">
